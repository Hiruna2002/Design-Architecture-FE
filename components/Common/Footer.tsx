        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/" className="text-gray-400 hover:text-[#a3e635] transition-colors xl:text-2xl">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-gray-400 hover:text-[#a3e635] transition-colors xl:text-2xl">
                  About
                </Link>
              </li>
              <li>
                <Link href="/services" className="text-gray-400 hover:text-[#a3e635] transition-colors xl:text-2xl">
                  Services
                </Link>
              </li>
              <li>
                <Link href="/projects" className="text-gray-400 hover:text-[#a3e635] transition-colors xl:text-2xl">
                  Projects
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-gray-400 hover:text-[#a3e635] transition-colors xl:text-2xl">
                  Contact
                </Link>
              </li>
            </ul>
